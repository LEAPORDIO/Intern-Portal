...
Good luck with your assignment!
  ...
  const Dashboard = () => (
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-600 to-blue-600 rounded-xl p-6 text-white">
        <h2 className="text-2xl font-bold mb-2">Welcome back, {userData.username.charAt(0).toUpperCase() + userData.username.slice(1)}!</h2>
        <p className="opacity-90">Shape your future with innovative projects and real-world experience</p>
      </div>
      ...
      <div className={`rounded-xl p-4 border ${
        ...
        <div className="flex items-center space-x-3">
          ...
          <button
            ...
            className="ml-auto p-2 rounded-lg bg-white shadow-sm hover:shadow-md transition-shadow disabled:opacity-50"
          >
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-purple-600">{userData.stats.totalAssignments}</div>
            <div className="text-sm text-gray-600">Total Assignments</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-green-600">{userData.stats.completedAssignments}</div>
            <div className="text-sm text-gray-600">Completed</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-orange-600">{userData.stats.pendingAssignments}</div>
        ...
        <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">₹{stats.revenueGenerated.toLocaleString()}</p>
            </div>
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
        ...
        <div className="space-y-3 max-h-64 overflow-y-auto">
          {liveUpdates.slice(0, 8).map((update, index) => (
            <div key={update.id} className={`flex items-center justify-between p-3 rounded-lg transition-all duration-300 ${
              ...
              <span className="text-sm">
                ...
                {update.isUserAction && <span className="ml-2 text-xs bg-purple-200 text-purple-800 px-2 py-1 rounded-full">You</span>}
              </span>
      ...
      <div className="bg-gradient-to-r from-orange-500 to-red-500 rounded-xl p-6 text-white">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-xl font-bold mb-2">🎯 Hiring Results</h3>
            <p className="opacity-90">Final selection results will be announced on July 3rd, 2025</p>
          </div>
  ...
  const Assignments = () => {
    ...
    return (
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <h2 className="text-2xl font-bold text-gray-800">Your Assignment</h2>
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">AWS EC2 & S3</p>
              </div>
            </div>
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            <button 
              onClick={downloadAssignmentPDF}
              className="px-3 py-2 bg-purple-100 text-purple-700 rounded-lg hover:bg-purple-200 transition-colors flex items-center space-x-2 text-sm"
            >
              <Download size={16} />
        ...
        {assignment.status === 'submitted' ? (
          <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">Assignment Already Submitted!</h3>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-purple-400 transition-colors">
                  ...
                  <p className="text-xs text-gray-500">ZIP files up to 50MB</p>
                  {selectedFile && (
        ...
        {submissionComplete && (
          <>
            ...
            <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-40 backdrop-blur-sm">
              <div className="bg-white rounded-xl p-8 text-center max-w-md mx-4 transform animate-pulse">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <h1 className="text-xl font-bold text-gray-900">Inncircles</h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4 text-sm text-gray-600">
              <span>Need help? Contact: intern-support@inncircles.com</span>
